...
public class FrmSeleccionUsuarios extends javax.swing.JFrame {
     ...
     */
    public FrmSeleccionUsuarios() throws ClassNotFoundException, IOException {
        initComponents();
        this.setLocationRelativeTo(null);
        Funciones funciones = new Funciones();
        funciones.leerUsuario();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 640, 460));
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(FrmSeleccionUsuarios.class.getName()).log(Level.SEVERE, null, ex);
